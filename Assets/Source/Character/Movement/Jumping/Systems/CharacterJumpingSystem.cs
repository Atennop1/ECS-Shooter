...
namespace Shooter.Character
{
    public sealed class CharacterJumpingSystem : ISystem
    {
        ...
        public void OnAwake()
        {
            var characterFilter = World.Filter.With<CharacterJumpingComponent>().With<CharacterSlidingComponent>().With<CharacterGroundedComponent>().With<CharacterCrouchingComponent>();
        ...
        public void OnUpdate(float deltaTime)
        {
            ...
            if (!grounded.IsActive || sliding.IsActive || crouching.IsActive || crouching.IsTransiting || !input.IsJumpKeyPressedThisFrame)
                return;
